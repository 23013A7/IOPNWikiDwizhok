...
<div class="iopn-editor">
    <?php if ($editor_saved): ?>
        <meta http-equiv="refresh" content="0;url=index.php?Page=<?= rawurlencode($FullPageName) ?>">
        <div class="iopn-editor-message iopn-editor-success">
            Страница сохранена.
            <a href="index.php?Page=<?= rawurlencode($FullPageName) ?>">Нажмите здесь, если переход не произошел</a>.
        </div>
    <?php else: ?>
        <?php if ($editor_error !== ''): ?>
