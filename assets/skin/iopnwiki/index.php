        ...
        <div class="HeadOgranitschiten">
            <div class="HeaderBorder">
                <a href="#" class="HeaderLogo">
                    <picture>
                        <source srcset="assets/skin/iopnwiki/FullLogoWeiss.png" media="(prefers-color-scheme: dark)">
                        <img class="Logo" src="assets/skin/iopnwiki/FullLogoSchwarz.png" alt="ИОПН — Энциклопедия">
                    </picture>
                </a>
                <nav class="pc">
                    <ul>
                ...
                <span class="info">
                    ...
                    <div class="info-panel right" style="min-width: 250px; padding: 15px;">
                        <div style="font-size:16px; position:relative; margin: -10px 10px;">
                            <?php require("components/render/render_meta_info.php")?>
                        </div>
                    </div>
                </span>
            </h1>
            <div id="Root">
                <?php require("components/render/render_page.php"); ?>
            </div>
        </div>
        <div class="End"></div>
    </main>
