...
function renderArticleTable($jsonFile, $baseUrl = '') {
    ...
    @media (prefers-color-scheme: dark) {
        .article-table { border-collapse: collapse; width: 100%; font-family: sans-serif; }
        .article-table th, .article-table td { border: 1px solid #dddddd29; padding: 8px; text-align: left; }        
        .article-table th { background-color: #dddddd0d; cursor: pointer; }      
        .article-table th:hover { background-color: #ddd; }        
        .article-table tr:nth-child(even) { background-color: #f9f9f90d; }        
        .status-error { color: red; font-weight: bold; }        
        .status-ok { color: green; }   
    }
    </style>
